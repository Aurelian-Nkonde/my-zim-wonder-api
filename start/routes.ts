      ...
      .group(() => {
        ...
        router
          .group(() => {
            ...
            router.get('/count', [CommentsController, 'AllCommentsCount'])
        ...
        router
          .group(() => {
            ...
            router.get('/user/count', [UpvotesController, 'getUserAllUpvotesCount'])
            router.get('/wonder/count', [UpvotesController, 'getWonderUpvoteCount'])
